...
import { GraphAssignedPatientComponent } from './elements/doctors-details/graph-assigned-patient/graph-assigned-patient.component';
import { RecentReviewComponent } from './elements/doctors-details/recent-review/recent-review.component';
import { GraphDoctorAbilitiesComponent } from './elements/doctors-details/graph-doctor-abilities/graph-doctor-abilities.component';
import { DoctorsReviewComponent } from './doctors-review/doctors-review.component';
import { PatientDetailsComponent } from './patient-details/patient-details.component';
import { AssignedDoctorCrousalComponent } from './elements/patient-details/assigned-doctor-crousal/assigned-doctor-crousal.component';
import { GraphPatientStatisticComponent } from './elements/patient-details/graph-patient-statistic/graph-patient-statistic.component';
...
@NgModule({
  declarations: [
    ...
    DashboardComponent,
    GraphRecoveredComponent,
    GraphVisitorsComponent,
    GraphPatientsComponent,
    ...
    GraphAssignedPatientComponent,
    RecentReviewComponent,
    GraphDoctorAbilitiesComponent,
    
    DoctorsReviewComponent,
    
    PatientDetailsComponent,
    AssignedDoctorCrousalComponent,
    GraphPatientStatisticComponent,
