...
export class ApiEndpointService {
  ...
  public static ENDPOINT = {
    ...
    PROGRAMS: `${ApiEndpointService.MAIN_CONTEXT}/business/programs/`,
    PROGRAM_ITEMS: `${ApiEndpointService.MAIN_CONTEXT}/business/program-items/`,
    GET_PROGRAMS: `${ApiEndpointService.MAIN_CONTEXT}/business/get-program-listing/`,
    ...
    CUSTOM_NOTIFICATION: `${ApiEndpointService.MAIN_CONTEXT}/communication/custom-notification/`,
    EVENT_REMINDERS: `${ApiEndpointService.MAIN_CONTEXT}/communication/get-event-reminders/`,
