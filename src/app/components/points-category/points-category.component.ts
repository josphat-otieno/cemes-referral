...
@Component({
  selector: 'app-points-category',
  templateUrl: './points-category.component.html',
  styleUrls: ['./points-category.component.css']
})
export class PointsCategoryComponent implements OnInit {
